        ...
        <div class="flex flex-col space-y-2 mt-2" v-if="user">
            <div class="flex flex-col items-center space-y-2">
                ...
                <div class="flex items-center justify-center space-x-2 w-full">
                    ...
                    <span class="truncate">{{ user.email }}</span></div>
            </div>
            <div class="flex items-center justify-center space-x-4 mt-4 ">
                <nuxt-link to="/profil" 
                    class="flex items-center space-x-2 py-3 px-4 bg-primary hover:bg-primary/90 transition-all text-white rounded-lg cursor-pointer">
                    <span>Profil</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                    </svg>
                </nuxt-link>
                <button class="flex items-center py-3 px-4 bg-gray-200 hover:bg-gray-300/70 transition-all rounded-lg cursor-pointer">
                    <span>Odjava</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
